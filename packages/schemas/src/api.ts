...
export const RecommendationResultSchema = z.object({
  ...
  avgMonthlyRent2r: z.number().nonnegative().optional(),
  distanceToHealthcareKm: z.number().nonnegative().optional(),
  distanceToTransitKm: z.number().nonnegative().optional(),
  distanceToGroceryKm: z.number().nonnegative().optional(),
  distanceToParkKm: z.number().nonnegative().optional(),
  distanceToSchoolKm: z.number().nonnegative().optional(),
  distanceToLibraryKm: z.number().nonnegative().optional(),
