...
export function rankMunicipalities(input: RankInput): RecommendationResult[] {
  ...
  for (const muni of municipalities) {
    ...
    results.push({
      ...
      avgMonthlyRent2r: m.avgMonthlyRent2r,
      distanceToHealthcareKm: m.distanceToHealthcareKm,
      distanceToTransitKm: m.distanceToTransitKm,
      distanceToGroceryKm: m.distanceToGroceryKm,
      distanceToParkKm: m.distanceToParkKm,
      distanceToSchoolKm: m.distanceToSchoolKm,
      distanceToLibraryKm: m.distanceToLibraryKm,
